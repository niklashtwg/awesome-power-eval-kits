...
- [ ] Download and read:
  ...
  - [ ] Evaluation board user guide (schematic, BOM, test conditions)
  - [ ] Any application notes referenced by the board

- [ ] Identify and write down:
  - [ ] Topology (flyback, buck, buck-boost, LLC, PSFB, ...)
  - [ ] Input range (Vin min / typ / max)
  - [ ] Output(s): voltage, current, rated power
  - [ ] Switching frequency (fixed / variable, range)
  - [ ] Critical components:
...
- [ ] Rebuild the **exact topology** of the eval board:
  - [ ] Use correct Vin range, Vout, switching frequency
  ...
  - [ ] Include output and input capacitors, ESR where relevant
